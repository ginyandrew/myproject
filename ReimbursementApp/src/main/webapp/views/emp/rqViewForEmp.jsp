...
<script src="scripts/emp/rqViewForEmp.js"></script>
</head>
<body>
			...
			<div class="col-md-10">
				...
				<div class="row ">
					<table class="table table-hover table-bordered">
						<thead>
							<tr>
								<th colspan="2">Reimbursement Request No. <c:out value="${rVos.no}" /></th>
							</tr>
						</thead>
						<tbody>
							<tr>
				...
				<div class="row btn-toolbar">
					<a role="button" class="btn btn-danger navbar-btn pull-right" href="/ReimbursementApp/rqListViewForEmp.do">Go Back to Request List</a>
				</div>
