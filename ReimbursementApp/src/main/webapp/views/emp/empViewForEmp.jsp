...
<script src="../../scripts/emp/empViewForEmp.js"></script>
</head>
<body>
			...
			<div class="col-md-10">
				...
				<div class="row  ">
					<table class="table table-hover table-bordered text-center">
						<thead>
							<tr>
								<th colspan="2">View Information of Emp001</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td style="width: 20%">Login ID</td>
								<td style="width: 80%">Purchase Supply for sales Dept / 150$</td>
							</tr>
							<tr>
								<td>Password</td>
								<td>************</td>
							...
							<tr>
								<td>Email</td>
								<td>emp001@gmail.com</td>
							</tr>
							<tr>
								<td>Contact No</td>
								<td>1 828 828 8883</td>
							</tr>
